...
summary: 'NetApp 다양한 방법으로 NetApp 콘솔에 대한 지원을 제공합니다. 지식 기반(KB) 문서와 커뮤니티 포럼 등 광범위한 무료 셀프 지원 옵션을 항상 이용할 수 있습니다. 지원 등록 시 웹 티켓팅을 통한 원격 기술 지원이 제공됩니다.' 
---
= NetApp 데이터 분류에 대한 도움말 받기
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
