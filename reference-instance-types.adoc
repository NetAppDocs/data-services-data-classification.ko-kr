...
[role="lead"]
NetApp Data Classification 소프트웨어는 특정 운영 체제 요구 사항, RAM 요구 사항 및 소프트웨어 요구 사항을 충족하는 호스트에서 실행되어야 합니다. 클라우드에 Data Classification을 배포할 경우, 모든 기능을 제대로 활용하려면 "대용량" 사양의 시스템을 사용하는 것이 좋습니다.
