...
NOTE: 파일 수준 규정 준수 세부 정보는 전체 분류 스캔을 수행한 경우에만 사용할 수 있습니다. 매핑 전용 스캔에서는 파일 수준 세부 정보가 생성되지 않습니다.
...
+
image:screenshot_compliance_investigation_page.png["'조사 결과'를 클릭한 후 파일에서 발견된 자세한 정보의 스크린샷입니다."]
